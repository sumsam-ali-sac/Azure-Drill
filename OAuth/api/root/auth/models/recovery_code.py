...
from auth_service.base.mongo_base import BaseMongoModel

# Type definition for recovery code types
RecoveryCodeType = Literal['account_recovery', 'password_reset', 'otp_reset', 'emergency_access']
...
class RecoveryCode(BaseMongoModel[str]):
    ...
    user_id: str = Field(..., description="ID of the user this recovery code belongs to")
    code_hash: str = Field(..., description="Hashed recovery code for security")
    recovery_type: RecoveryCodeType = Field(..., description="Type of recovery this code enables")
    expiry: datetime = Field(..., description="When this recovery code expires")
    is_used: bool = Field(default=False, description="Whether this recovery code has been used")
    used_at: Optional[datetime] = Field(None, description="When this recovery code was used")
    used_ip: Optional[str] = Field(None, description="IP address where code was used")
    used_user_agent: Optional[str] = Field(None, description="User agent when code was used")
    generated_by: Optional[str] = Field(None, description="Who/what generated this code")
    metadata: dict = Field(default_factory=dict, description="Additional recovery metadata")
    ...
    @classmethod
    def create_account_recovery_code(cls, user_id: str, code_hash: str, expiry_days: int = 7, 
                                   generated_by: Optional[str] = None) -> 'RecoveryCode':
    ...
    @classmethod
    def create_password_reset_code(cls, user_id: str, code_hash: str, expiry_hours: int = 24) -> 'RecoveryCode':
    ...
    @classmethod
    def create_otp_reset_code(cls, user_id: str, code_hash: str, expiry_hours: int = 48) -> 'RecoveryCode':
    ...
    @classmethod
    def create_emergency_access_code(cls, user_id: str, code_hash: str, expiry_hours: int = 1, 
                                   generated_by: Optional[str] = None) -> 'RecoveryCode':
