...
class BackupCode(BaseMongoModel[str]):
    ...
    is_used: bool = Field(default=False, description="Whether this backup code has been used")
    used_at: Optional[datetime] = Field(None, description="When this backup code was used")
    ...
    code_set_id: Optional[str] = Field(None, description="ID of the backup code set this belongs to")
    ...
    @classmethod
    def create_backup_code(cls, user_id: str, code_hash: str, code_set_id: Optional[str] = None) -> 'BackupCode':
