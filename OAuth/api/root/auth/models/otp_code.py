...
# Type definition for OTP code types
...
class OTPCode(BaseMongoModel[str]):
    ...
    metadata: dict = Field(default_factory=dict, description="Additional metadata for the code")
    ...
    @classmethod
    def create_setup_code(cls, user_id: str, code_hash: str, expiry_minutes: int = 15) -> 'OTPCode':
    ...
    @classmethod
    def create_login_code(cls, user_id: str, code_hash: str, expiry_minutes: int = 5) -> 'OTPCode':
    ...
    @classmethod
    def create_recovery_code(cls, user_id: str, code_hash: str, expiry_hours: int = 24) -> 'OTPCode':
