...
class TokenManager:
    ...
    def create_token(
        self, payload: Dict[str, Any], expires_minutes: int, token_type: str = "access"
    ) -> str:
        """
        ...
        try:
            ...
            logger.debug(
                f"Created {token_type} token for subject: {payload.get('sub', 'unknown')}"
            )
            return token
    ...
    def refresh_access_token(self, refresh_token: str) -> str:
        ...
        return self.create_token(
            access_payload, config.ACCESS_TOKEN_EXPIRE_MINUTES, "access"
        )
