...
class InputValidator:
    ...
    def validate_password(self, password: str, raise_exception: bool = True) -> Dict[str, Any]:
        """
        ...
        # Additional warnings
        if len(password) > 128:
            result["warnings"].append("Password is very long and may cause performance issues")
    ...
    def validate_oauth_provider(self, provider: str, raise_exception: bool = True) -> bool:
        """
        ...
        if provider not in SUPPORTED_OAUTH_PROVIDERS:
            if raise_exception:
                raise AuthBaseException(400, f"Unsupported OAuth provider. Supported: {SUPPORTED_OAUTH_PROVIDERS}")
            return False
    ...
    def validate_redirect_url(self, url: str, allowed_hosts: Optional[List[str]] = None) -> bool:
        """
