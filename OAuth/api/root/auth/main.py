...
class AuthServiceCLI:
    ...
    def register_user(self):
        ...
        try:
            ...
            user = self.auth_service.register(user_data)
    ...
    def change_password(self):
        ...
        try:
            ...
            success = self.auth_service.change_password(user.id, old_password, new_password)
    ...
    def reset_password(self):
        ...
        try:
            reset_token = self.auth_service.reset_password(email)
            ...
            if complete == 'y':
                new_password = input("New Password: ").strip()
                success = self.auth_service.confirm_password_reset(reset_token, new_password)
