...
from auth_service.utils.validators import EmailValidator, PasswordValidator
...
class AuthService(BaseAuthService):
    ...
    def authenticate(self, credentials: Dict[str, Any], set_cookies: bool = False) -> Union[Dict[str, Any], Response]:
        ...
        try:
            ...
            if not user.hashed_password:
                raise InvalidCredentialsError("Password authentication not set up for this user")
    ...
    def change_password(self, user_id: str, old_password: str, new_password: str) -> bool:
        ...
        # Verify old password
        if not user.hashed_password or not self._security_utils.verify_password(old_password, user.hashed_password):
    ...
    async def change_password_async(self, user_id: str, old_password: str, new_password: str) -> bool:
    ...
    async def confirm_password_reset_async(self, reset_token: str, new_password: str) -> bool:
    ...
    def logout(self, access_token: str, clear_cookies: bool = False) -> Union[bool, Response]:
        """
    ...
    async def logout_async(self, access_token: str, clear_cookies: bool = False) -> Union[bool, Response]:
