...
def get_user_manager(user_repo: UserRepository = Depends(get_user_repository)) -> UserManager:
    """Get UserManager instance."""
    return UserManager(user_repo)

def get_token_manager(token_repo: TokenRepository = Depends(get_token_repository)) -> TokenManager:
...
def get_social_auth_service(
    ...
    return SocialAuthService(user_manager, token_manager, google_provider, azure_provider)
