...
class AccountLockedError(AuthBaseException):
    ...
    def __init__(self, detail: str = "Account is locked due to too many failed attempts"):
        super().__init__(
            status_code=HTTP_403_FORBIDDEN,
            detail=detail,
...
def get_exception_by_code(error_code: str, detail: Optional[str] = None) -> AuthBaseException:
