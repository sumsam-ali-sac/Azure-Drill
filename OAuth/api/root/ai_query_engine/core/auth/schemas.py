...
class UserLogin(BaseAuthSchema):
    ...
    otp_code: Optional[str] = Field(None, min_length=6, max_length=6, description="OTP code")
...
class UserProfile(BaseAuthSchema):
    ...
    oauth_providers: List[str] = Field(default=[], description="Connected OAuth providers")
